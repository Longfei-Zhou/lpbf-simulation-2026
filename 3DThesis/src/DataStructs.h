...
// Material constants
struct Material {
	double kon; // Thermal conductivity
	double rho; // Density
	double cps; // Specific heat
	double T_liq; // Liquidus Temperature
	double T_init; // Initial temperature (preheat/ambient)
...
struct Beam {
	...
	double eff; // Absorption efficiency
	double q; // Beam Power
...
struct SimParams {
	...
	bool secondary = false;		// Calculate secondary solidification
};
